import { Box, Grid, GridItem, Image, Spacer } from "@chakra-ui/react";
      ...
      <Box p={8}>
        ...
        <Box px={{ base: 0, sm: 0, md: 100, lg: 200 }}>
          ...
          >
            ...
            <GridItem colSpan={1}>Exterior - NE</GridItem>
            <GridItem colSpan={2}>
              The gable end above the horizontal flashing appears to be rotting
              in places.
              <Spacer h={5} />
              <Image src="3.jpg" />
            </GridItem>
            <GridItem colSpan={2}>
              Replace cladding, the problem may be sourcing the shadow clad, if
              sourced we can replace as like for like. If not and a different
              cladding used it will have to consented.
            </GridItem>
            ...
            <GridItem colSpan={2}>Replace glass with opaque glass.</GridItem>
            ...
            <GridItem colSpan={1}>Exterior - NE</GridItem>
            <GridItem colSpan={2}>
              Investigate Leak. According to client when it rains water pools by
              the back door.
              <Spacer h={5} />
              <Image src="5.jpg" />
              <Spacer h={5} />
            ...
            <GridItem colSpan={2}>
              Possible nib and concrete sloped away from house. This timber may
              need replacing.
            </GridItem>
            <GridItem colSpan={1}>Charge up.</GridItem>
            {/* Item */}
            ...
            <GridItem colSpan={2}>New Shower.</GridItem>
            ...
            <GridItem colSpan={2}>New Extractor Fan.</GridItem>
            <GridItem colSpan={1}>Installed by others.</GridItem>
            {/* Item */}
            <Spacer h={5} />
            <Spacer h={5} />
            ...
            <GridItem colSpan={1}>
              Charge Up. A plumber may also be required.
            </GridItem>
            {/* Item */}
            <Spacer h={5} />
            <Spacer h={5} />
